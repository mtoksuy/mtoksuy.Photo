		...
		switch($preview_frg) {
			...
			$thumbnail_html = ('
				<div class="article_thumbnail">
					<img class="great_image_100 m_b_15" width="640" height="400" title="'.$value["title"].'" alt="'.$value["title"].'" src="'.HTTP.'assets/img/'.$draft.'article/'.$year_time.'/one_third/'.$value["thumbnail_image"].'">
				</div>');
