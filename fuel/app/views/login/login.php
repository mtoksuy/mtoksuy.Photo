<!DOCTYPE html>
	...
	<body>
		<!--  -->
		<div class="login">
			<h1 class="text_center"><a href="<?php echo Uri::base(); ?>" title="Powered by Programmerbox"><img src="http://localhost/mtoksuy/assets/img/logo/logo_5.png" alt="mtoksuy.Photo" title="mtoksuy.Photo" height="" width="130"></a></h1>
			<!-- login_form -->
